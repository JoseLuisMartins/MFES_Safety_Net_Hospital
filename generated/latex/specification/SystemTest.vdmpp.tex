...
public testFailForgotToAddDoctor: () ==> ()
 testFailForgotToAddDoctor () == (*@\vdmnotcovered{(}@*)
   ...
   dcl hos1: Hospital := new Hospital("Hospital Sao Joao",mk_ModelUtils`Location("Porto", (*@\vdmnotcovered{"Alameda Prof. Hernâni Monteiro"}@*),(*@\vdmnotcovered{"4200-319"}@*)), {(*@\vdmnotcovered{<ADSE>}@*),(*@\vdmnotcovered{<MEDICARE>}@*)});
   dcl doc1: Doctor := new (*@\vdmnotcovered{Doctor}@*)((*@\vdmnotcovered{"jose"}@*),(*@\vdmnotcovered{35}@*),(*@\vdmnotcovered{<ORTOPEDIA>}@*));
   ...
   safetyNet.associateDoctorToHospital((*@\vdmnotcovered{hos1}@*).(*@\vdmnotcovered{getId}@*)(), (*@\vdmnotcovered{doc1}@*).(*@\vdmnotcovered{getId}@*)());
...
@*)
 ...
 public testFailForgotToAddHospital: () ==> ()
  testFailForgotToAddHospital () == (*@\vdmnotcovered{(}@*)
   ...
   dcl doc1: Doctor := (*@\vdmnotcovered{new}@*) (*@\vdmnotcovered{Doctor}@*)("jose",(*@\vdmnotcovered{35}@*),(*@\vdmnotcovered{<ORTOPEDIA>}@*));
...
(*@
\label{testFailCanNotRemoveAnAgreement:1022}
@*)
  );
 ...
 public testFailCanNotRemoveAnAgreement: () ==> ()
  testFailCanNotRemoveAnAgreement () == (*@\vdmnotcovered{(}@*)
    ...
    dcl hos1: Hospital := new (*@\vdmnotcovered{Hospital}@*)((*@\vdmnotcovered{"Hospital Sao Joao"}@*),(*@\vdmnotcovered{mk\_ModelUtils`Location}@*)("Porto", "Alameda Prof. Hernâni Monteiro",(*@\vdmnotcovered{"4200-319"}@*)), (*@\vdmnotcovered{\{}@*)(*@\vdmnotcovered{<ADSE>}@*),(*@\vdmnotcovered{<MEDICARE>}@*)});
   ...
   safetyNet.removeAgreementFromHospital(hos1.getId(),(*@\vdmnotcovered{<MEDIS>}@*));
   
   (*@\vdmnotcovered{safetyNet}@*).clearInstance();
   
  );
(*@
\label{testFailSearchForADoctor:1042}
@*)
  ...
  public testFailSearchForADoctor: () ==> ()
   ...
   doc2 := safetyNet.getDoctorById(doc1.(*@\vdmnotcovered{getId}@*)());
   
   (*@\vdmnotcovered{safetyNet}@*).clearInstance();
   
(*@
\label{testFailDisassociatingADoctorFromAnHospital:1059}
@*)
  );
...
@*)
 ...
 public testFailCreatingAnAppointment: () ==> ()
  ...
  dcl pat2: Patient := (*@\vdmnotcovered{new}@*) (*@\vdmnotcovered{Patient}@*)((*@\vdmnotcovered{"Maria"}@*), (*@\vdmnotcovered{38}@*), (*@\vdmnotcovered{"Doença pulmonar"}@*));
  ...
  safetyNet.addPatient((*@\vdmnotcovered{pat1}@*));
  ...
  (*@\vdmnotcovered{app1}@*) := new Appointment(mk_ModelUtils`Date(2018,12,21,8,30), hos1.getId(), doc1.(*@\vdmnotcovered{getId}@*)(), (*@\vdmnotcovered{pat1}@*).(*@\vdmnotcovered{getId}@*)());
  (*@\vdmnotcovered{app2}@*) := new Appointment(mk_ModelUtils`Date(2018,12,21,8,30), hos1.getId(), (*@\vdmnotcovered{doc1}@*).(*@\vdmnotcovered{getId}@*)(), (*@\vdmnotcovered{pat2}@*).(*@\vdmnotcovered{getId}@*)());
